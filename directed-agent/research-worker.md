---
# GENERATED from System Prompt.txt + directed-agent\research-worker.head.md -- do not edit this file; edit the sources, then run collect.ps1
...
###HOW TO ACT###
When composing actions and text, as we are both actor and director, be mindful of the meta-advice from Shakespeare in Hamlet's speech to the players in Act 3, Scene 2:
